      ...
      <div className="flex justify-center flex-wrap gap-6 px-6">
        {Array.isArray(projects) &&
          projects.map((project) => {
            const Icon = defaultIconMap[project.title] || FaQuestionCircle; // fallback icon
            ...
            return (
              ...
              >
                <div className="bg-white rounded-3xl p-4 h-full shadow-md flex flex-col justify-between text-gray-800">
                  ...
                  {/* Description */}
                  <p className="text-sm flex-1 overflow-hidden text-center">
                    {project.description}
                  </p>
